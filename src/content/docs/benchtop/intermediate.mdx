...
3. Go to a benchtop and turn on the soldering iron:
    - Make sure the power switch is flipped on (red is showing, screen turns on)
    - Select an iron by pressing 1, 2, or 3. You want the one with a pointy tip.
    - Press the left and right arrows simultaneously to turn on the iron. A blue ring should illuminate on the iron.
    - Adjust the temperature to be around 350-375 F.
